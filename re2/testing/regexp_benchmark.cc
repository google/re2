...
void CacheFill(benchmark::State& state, int n, SearchImpl *srch) {
  ...
  state.SetBytesProcessed(static_cast<int64_t>(iters)*s.size());
}

void CacheFillPCRE(benchmark::State& state) { CacheFill(state, SearchCachedPCRE); }
void CacheFillRE2(benchmark::State& state)  { CacheFill(state, SearchCachedRE2); }
void CacheFillNFA(benchmark::State& state)  { CacheFill(state, SearchCachedNFA); }
void CacheFillDFA(benchmark::State& state)  { CacheFill(state, SearchCachedDFA); }
