...
# Some other ifeq would be better here!:
# MAKE_SHARED_LIBRARY=$(CXX) -shared -Wl,-soname,libre2.so.$(SONAME),-M,libre2.symbols.illumos $(LDFLAGS)
$(info uname:		$(shell uname))
$(info uname -v:	$(shell uname -v))
$(info Illumos LINKER:	$(shell /usr/bin/ld --version))
else
