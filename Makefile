...
# We use OTESTFILES for testing the shared lib, only it is built differently.
STESTS=$(patsubst obj/test/%,obj/so/test/%,$(TESTS))
SBIGTESTS=$(patsubst obj/test/%,obj/so/test/%,$(BIGTESTS))
