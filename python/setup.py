...
def rename_and_rewrite_file(inpath, outpath, outmode='w'):
  with open(inpath, 'r') as file:
    contents = relativize_native_import(file.read())
  with open(outpath, outmode) as file:
    file.write(contents)

rename_and_rewrite_file('re2.py', 're2/__init__.py', outmode='x')
rename_and_rewrite_file('re2.pyi', 're2/__init__.pyi')

shutil.copyfile('_re2.pyi', 're2/_re2.pyi')

with open('re2/py.typed', 'w') as file:
  pass
